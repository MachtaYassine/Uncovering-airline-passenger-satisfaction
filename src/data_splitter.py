...
if __name__ == "__main__":
    ...
    #except FileNotFoundError:
        #logging.error("The dataset file was not found. Please check the path.")
        #exit()

    # Specify the target column
    #target_column = "satisfaction"

    # Initialize the data splitter with a simple train-test split strategy
    #data_splitter = DataSplitter(SimpleTrainTestSplitStrategy(test_size=0.2, random_state=42))

    # Perform the split
    #X_train, X_test, y_train, y_test = data_splitter.split(df, target_column=target_column)
